...
<html>
<head>
    <title>Lalaland | Playlist Square</title>
...
<div class="stock_box">
    ...
    <div class="col-md-10 sap_tabs">
        ...
        $sql = "SELECT pid,pname,username,pcover FROM playlist JOIN user USING(uid) WHERE private=0 ORDER BY views desc limit 200";
        $result = mysqli_query($conn, $sql);
        $number = mysqli_num_rows($result);
        echo "<div id='horizontalTab' style='display: block; width: 100%; margin: 0px;'>";
        echo "<ul class='resp-tabs-list'>";
        echo "<li class='resp-tab-item' aria-controls='tab_item-0' role='tab'><span>Playlist Squares(" . $number . ")</span></li>";
        ...
        if (mysqli_num_rows($result) > 0) 
        {
            ...
            {
                echo "<li><a href='singleP.php?pid=$row[0]&&edit=0'>";
            ...
            echo "<ul class='size'>";
            echo "<h3></h3>";
            echo "<li><a href='playlist.php'>Back</a></li>";
            echo "</ul>";
            echo "</ul>";
        } 
        else 
