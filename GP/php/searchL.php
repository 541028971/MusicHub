...
<div class="stock_box">
    ...
    <div class="col-md-10 sap_tabs">
        ...
        $sql = "SELECT sname, album, cover,s_id FROM songs WHERE sname='$search' OR album='$search' OR arrangement='$search' OR stype='$search' limit 200";
        $result = mysqli_query($conn, $sql);
        $number = mysqli_num_rows($result);
        //echo (microtime());
        echo "<div id='horizontalTab' style='display: block; width: 100%; margin: 0px;'>";
        echo "<ul class='resp-tabs-list'>";
        echo "<li class='resp-tab-item' aria-controls='tab_item-0' role='tab'><span>Results(" . $number . ")</span></li>";
