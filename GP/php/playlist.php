...
<html>
<head>
    <title>Lalaland | Playlist page</title>
...
<div class="stock_box">
    <div class="col-md-2 stock_left">
        <div class="w_sidebar">
            ...
            <section class="sky-form">
                <a href="favourite.php"><h4>Favourites</h4></a>
                <div class="col col-4">
    ...
    <div class="col-md-10 sap_tabs">
        ...
        <ul class="list1">
            <li id="search">
                <form action="searchL.php" method="POST">
        ...
        $sql = "SELECT pid,pname,username,pcover FROM playlist JOIN user USING(uid) WHERE username='$unamegot' limit 200";
        $result = mysqli_query($conn, $sql);
        $number = mysqli_num_rows($result);
        echo "<div id='horizontalTab' style='display: block; width: 100%; margin: 0px;'>";
        echo "<ul class='resp-tabs-list'>";
        echo "<li class='resp-tab-item' aria-controls='tab_item-0' role='tab'><span>Playlists(" . $number . ")</span></li>";
        ...
        if (mysqli_num_rows($result) > 0) 
        {
            ...
            {
                echo "<li><a href='singleP.php?pid=$row[0]&&edit=1'>";
                echo "<img src='$row[3]' class='img-responsive' alt=''/>";
                echo "<div class='tab_desc'>";
                echo "<p>$row[1]</p>";
                if($row[1] != "Favourite Songs")
                {
                    echo "<h4><a href='createplaylist.php?edit=$row[0]'><font color='green'>Edit It</font></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href='deleteplaylist.php?pid=$row[0]'><font color='red'>Delete It</font></a></h4>";
                }
                echo "</div>";
                echo "</a></li>";
            }
            ...
            echo "<ul class='size'>";
            echo "<h3></h3>";
            echo "<li><a href='createplaylist.php?edit=0'>New Playlist</a></li>";
            echo "<li><a href='playlistsquare.php'>Playlist Square</a></li>";
            echo "</ul>";
            echo "</ul>";
        } 
        else 
        {
            echo "No playlists found. <a href='createplaylist.php?edit=0'>Create One?</a>";
        }
        echo "</div>";
        echo "</div>";
        echo "</div>";
